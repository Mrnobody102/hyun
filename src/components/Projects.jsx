                    ...
                    <div className="flex items-center justify-center gap-4 mb-4">
                        <h2 className="text-4xl md:text-5xl font-bold">
                            <span className="bg-gradient-to-r from-slate-800 via-amber-600 to-yellow-600 dark:from-amber-300 dark:via-yellow-300 dark:to-amber-200 bg-clip-text text-transparent">
                                {language === 'vi' ? 'Side Projects nổi bật' : 'Featured Personal Projects'}
                            </span>
                        </h2>
                    </div>
                                ...
                                <div className={`${compact ? 'p-4' : 'p-6'} flex-1 flex flex-col z-10`}>
                                    ...
                                    <div className="flex flex-wrap gap-2 mb-6">
                                        {(compact ? project.tags.slice(0, 6) : project.tags).map((tag) => (
                                            <span
                                                key={tag}
                                                className="flex items-center gap-2 px-2.5 py-1 bg-slate-50 dark:bg-slate-700/50 text-slate-600 dark:text-slate-200 rounded-md text-[10px] font-bold uppercase tracking-wider border border-slate-200 dark:border-slate-600/50 backdrop-blur-sm"
                                            >
