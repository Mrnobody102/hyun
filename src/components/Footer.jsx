            ...
            <div className="container mx-auto max-w-6xl">
                ...
                >
                    <div className="flex items-center justify-center gap-2 mb-4">
                        <span className="text-sm text-slate-300">Made with</span>
                        <motion.div
                        ...
                        <span className="text-sm text-slate-300">by</span>
                    ...
                    <p className="text-sm text-slate-400">
                        © {currentYear} All rights reserved. Built with React, TailwindCSS & Framer Motion
                    </p>
                </motion.div>
            </div>
        </footer>
